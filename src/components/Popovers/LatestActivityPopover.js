    ...
    <Popover
      ...
      bodyContent={
        <Flex direction={{ default: 'column', sm: 'row' }}>
          <Flex>
            <FlexItem>
              <DescriptionList hasGutter title="Run on">
                <span>
                  <DateFormat type="exact" date={mostRecent.created_at} />
                </span>
              </DescriptionList>
            </FlexItem>
            <FlexItem>
              <DescriptionList hasGutter title="Run by">
