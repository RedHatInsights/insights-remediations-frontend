...
//TODO: Figure out how to add this empty state back
...
export const ExecuteModal = ({
  ...
  const handleExecute = () => {
    ...
    //TODO: ensure exlude is actually getting passed.
  ...
  return (
    ...
    >
      <div>
        ...
        <TableStateProvider
          tableId="execute-modal-table"
          pagination={false}
          emptyState={<EmptyExecutePlaybookState />}
        >
          <RemediationsTable
            ...
            //TODO:Update the styling to match the current set up
            columns={[...columns]}
          />
        </TableStateProvider>
      </div>
