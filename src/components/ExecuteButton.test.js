...
const data = [
    { executor_id: '722ec903-f4b5-4b1f-9c2f-23fc7b0ba390', executor_type: 'satellite', executor_name: 'Satellite 1 (connected)',
        system_count: 1, connection_status: 'connected' },
    { executor_id: null, executor_type: null, executor_name: null, system_count: 4, connection_status: 'no_executor' }
];

describe('Execute button', () => {

    test('fullfiled request', () => {
        const tree = mount(<ExecuteButton
            data={ data }
            isLoading
            status={ 'fullfiled' }
            issueCount={ 1 }
