              ...
              <Button
                icon={
                  <PencilAltIcon
                    color={
                      editing
                        ? 'var(--pf-t--global--text--color--regular)' /* CODEMODS: original v6 color was --pf-v6-global--palette--black-300 */
                        : undefined
                    }
                  />
                }
                  ...
                  <FlexItem>
                    <Flex spaceItems={{ default: 'spaceItemsXs' }}>
                      <Button
                        icon={
                          <CheckIcon
                            color={
                              nameStatus !== 'valid'
                                ? 'var(--pf-t--global--icon--color--disabled)' /* CODEMODS: original v6 color was --pf-v6-global--disabled-color--200 */
                                : 'var(--pf-t--global--text--color--link--default)' /* CODEMODS: original v6 color was --pf-v6-global--link--Color */
                            }
                          />
                        }
                        variant="link"
                      ...
                      <Button
                        icon={
                          <TimesIcon
                            color="var(--pf-t--global--text--color--subtle)" /* CODEMODS: original v6 color was --pf-v6-global--icon--Color--light--dark */
                          />
                        }
                        variant="link"
