...
import { useExpander, useFilter, usePagination, useSelector, useSorter } from './table';
...
describe('table hooks', () => {
    ...
    describe('useExpander', function () {
        ...
        test('errors if register() not called', () => {
            ...
            expect(() => act(() => result.current.props.onCollapse(undefined, 1, true))).toThrow('register() not called on useExpander()');
        });
        ...
        test('errors if row does not define id', () => {
            ...
            expect(() => act(() => result.current.props.onCollapse(undefined, 1, true))).toThrow('row does not define id!');
        });
    });
    ...
    describe('useSelector', function () {
        ...
        test('errors if register() not called', () => {
            ...
            expect(() => act(() => result.current.props.onSelect(undefined, true, 2))).toThrow('register() not called on useSelector()');
        });
    });
});
